...
const numbers = [40, 80, 120, 160, 200, 240, 280, 320, 360, 400];
...
function createGame() {
  ...
  numbers.forEach((num, index) => {
    ...
    question.innerHTML = `
      <span style="font-size: 22px; font-weight: bold;">40 x ${index + 1} =</span> 
...
function verificar() {
  ...
  fetch("/ejercicios_tercero/tabla4/guardar-calificacion", {
    method: "POST",
    headers: {
