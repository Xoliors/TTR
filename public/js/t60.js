...
const numbers = [60, 120, 180, 240, 300, 360, 420, 480, 540, 600];
...
function createGame() {
  ...
  numbers.forEach((num, index) => {
    ...
    question.innerHTML = `
      <span style="font-size: 22px; font-weight: bold;">60 x ${index + 1} =</span> 
...
function verificar() {
  ...
  fetch("/ejercicios_tercero/tabla6/guardar-calificacion", {
    method: "POST",
    headers: {
