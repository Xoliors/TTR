...
const reporteController = require('../controllers/reporte2');
...
router.get('/promedios-ejercicio2', reporteController.promedioPorEjercicio);
router.get('/calificaciones-fecha2', reporteController.calificacionesPorFecha);
router.get('/intentos2', reporteController.intentosPorEjercicio);
