...
function verificar() {
    intentos++;
    let correctos = 0;
    if (document.getElementById("recuadro1").childElementCount === 25) correctos++;
    if (document.getElementById("recuadro2").childElementCount === 30) correctos++;
    if (document.getElementById("recuadro3").childElementCount === 28) correctos++;
    if (document.getElementById("recuadro4").childElementCount === 30) correctos++;
    if (document.getElementById("recuadro5").childElementCount === 42) correctos++;
