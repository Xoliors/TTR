...
async function cargarDashboard() {
  const barras = await fetch('/reportes/calificaciones-fecha').then(res => res.json());
  const intentos = await fetch('/reportes/intentos').then(res => res.json());
  const datosEjercicios = await fetch('/reportes/promedios-ejercicio').then(res => res.json());
