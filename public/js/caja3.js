...
function generateObjects() {
  if (globalAttempts < MAX_ATTEMPTS) {
    footballCount = Math.floor(Math.random() * 101); // Entre 0 y 20 pelotas de fútbol
    basketballCount = Math.floor(Math.random() * 101); // Entre 0 y 20 pelotas de baloncesto
    baseballCount = Math.floor(Math.random() * 101); // Entre 0 y 20 pelotas de béisbol
