...
const numbers = [80, 160, 240, 320, 400, 480, 560, 640, 720, 800];
...
function createGame() {
  ...
  numbers.forEach((num, index) => {
    ...
    question.innerHTML = `
      <span style="font-size: 22px; font-weight: bold;">80 x ${index + 1} =</span> 
...
function verificar() {
  ...
  fetch("/ejercicios_tercero/tabla8/guardar-calificacion", {
    method: "POST",
    headers: {
