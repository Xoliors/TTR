...
const numbers = [70, 140, 210, 280, 350, 420, 490, 560, 630, 700];
...
function createGame() {
  ...
  numbers.forEach((num, index) => {
    ...
    question.innerHTML = `
      <span style="font-size: 22px; font-weight: bold;">70 x ${index + 1} =</span> 
...
function verificar() {
  ...
  fetch("/ejercicios_tercero/tabla7/guardar-calificacion", {
    method: "POST",
    headers: {
