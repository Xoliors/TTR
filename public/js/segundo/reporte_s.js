...
async function cargarDashboard() {
  const barras = await fetch('/reportes2/calificaciones-fecha2').then(res => res.json());
  const intentos = await fetch('/reportes2/intentos2').then(res => res.json());
  const datosEjercicios = await fetch('/reportes2/promedios-ejercicio2').then(res => res.json());
