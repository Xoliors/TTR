 const id_ejercicio = 19;
  ...
  const numbers = [6, 12, 18, 24, 30, 36, 42, 48, 54, 60];
  ...
  function createGame() {
    ...
    numbers.forEach((num, index) => {
      ...
      question.innerHTML = `
        <span style="font-size: 22px; font-weight: bold;">6 x ${index + 1} =</span> 
  ...
  function verificar() {
    ...
    fetch("/ejercicios_segundo/tabla6/guardar-calificacion", {
      method: "POST",
      headers: {
