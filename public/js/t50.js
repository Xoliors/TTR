...
const numbers = [50, 100, 150, 200, 250, 300, 350, 400, 450, 500];
...
function createGame() {
  ...
  numbers.forEach((num, index) => {
    ...
    question.innerHTML = `
      <span style="font-size: 22px; font-weight: bold;">50 x ${index + 1} =</span> 
...
function verificar() {
  ...
  fetch("/ejercicios_tercero/tabla5/guardar-calificacion", {
    method: "POST",
    headers: {
