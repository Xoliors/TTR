 const id_ejercicio = 22;
  ...
  const numbers = [9, 18, 27, 36, 45, 54, 63, 72, 81, 90];
  ...
  function createGame() {
    ...
    numbers.forEach((num, index) => {
      ...
      question.innerHTML = `
        <span style="font-size: 22px; font-weight: bold;">9 x ${index + 1} =</span> 
  ...
  function verificar() {
    ...
    fetch("/ejercicios_segundo/tabla9/guardar-calificacion", {
      method: "POST",
      headers: {
