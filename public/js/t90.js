...
const numbers = [90, 180, 270, 360, 450, 540, 630, 720, 810, 900];
...
function createGame() {
  ...
  numbers.forEach((num, index) => {
    ...
    question.innerHTML = `
      <span style="font-size: 22px; font-weight: bold;">90 x ${index + 1} =</span> 
...
function verificar() {
  ...
  fetch("/ejercicios_tercero/tabla9/guardar-calificacion", {
    method: "POST",
    headers: {
